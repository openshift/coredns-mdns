...
WORKDIR /go/src/github.com/openshift-metalkube/coredns-mdns
COPY . .
RUN git clone https://github.com/coredns/coredns /go/src/github.com/coredns/coredns
WORKDIR /go/src/github.com/coredns/coredns
RUN git apply /go/src/github.com/openshift-metalkube/coredns-mdns/containerization/mdns.patch && \
    make
